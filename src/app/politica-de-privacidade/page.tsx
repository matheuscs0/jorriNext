export default function Politica() {
  return (
    <section className="w-full flex mt-20 flex-col gap-5  p-5">
      <div className="w-full flex flex-col justify-center items-center">
        <h1 className="text-lg font-bold">Politica de privacidade</h1>
        <p className="flex-col justify-center w-full text-center sm:w-1/2 md:w-1/2">
          A Jorri Joias, pessoa jurídica de direito privado, leva a sua
          privacidade a sério e zela pela segurança e proteção de dados de todos
          os seus clientes, parceiros, fornecedores e usuários
          (&quot;Usuários&quot; ou &quot;você&quot;) do site
          &quot;www.jorrijoias.com.br&quot; e qualquer outro site, Loja,
          aplicativo operado pelo Lojista (aqui designados, simplesmente,
          &quot;Loja&quot;). <br />
          <br />
          Esta Política de Privacidade (&quot;Política de Privacidade&quot;)
          destina-se a informá-lo sobre o modo como nós utilizamos e divulgamos
          informações coletadas em suas visitas à nossa Loja e em mensagens que
          trocamos com você (&quot;Comunicações&quot;). Esta Política de
          ...
          entre em contato com contato.jorri@gmail.com <br />
          <br />
          ...
          acesso a esses links fará com que você deixe a Loja e possa resultar
          na coleta ou compartilhamento de informações sobre você por terceiros.
          Nós não controlamos, endossamos ou fazemos quaisquer representações
          sobre esses sites de terceiros ou suas práticas de privacidade, que
          podem ser diferentes das nossas. Recomendamos que você revise a
          política de privacidade de qualquer site com o qual você interaja
          antes de permitir a coleta e o uso de seus Dados Pessoais. <br />
          <br />
          ...
          informações nos termos desta Política de Privacidade. <br />
          <br />
          ...
          &quot;Leis de Proteção de Dados&quot; significa todas as disposições
          legais que regulem o Tratamento de Dados Pessoais, incluindo, porém
          sem se limitar, a Lei nº 13.709/18, Lei Geral de Proteção de Dados
          Pessoais (&quot;LGPD&quot;). <br />
          <br />
          ...
          Exemplos de como usamos os dados incluem: <br />
          Viabilizar que você adquiria produtos e/ou serviços na Loja; <br />
          ...
          Para personalizar o envio de publicidades para você, baseada em seu
          interesse em nossa Loja; e <br />
          ...
          lei e para fins comerciais razoáveis. <br />
          Além disso, os Dados Pessoais fornecidos também podem ser utilizados
          na forma que julgarmos necessária ou adequada: <br />
          (a) nos termos das Leis de Proteção de Dados; <br />
          (b) para atender exigências de processo judicial; <br />
          ...
          residência; <br />
          (d) para proteger nossas operações; <br />
          (e) para proteger direitos, privacidade, segurança nossos, seus ou de
          terceiros; <br />
          (f) para detectar e prevenir fraude; <br />
          (g) permitir-nos usar as ações disponíveis ou limitar danos que
          venhamos a sofrer; <br />
          (h) de outros modos permitidos por lei; <br />
          <br />
          A PLATAFORA NÃO SE DESTINA A PESSOAS COM MENOS DE 18 (DEZOITO) ANOS E
          PEDIMOS QUE TAIS PESSOAS NÃO NOS FORNEÇAM QUALQUER DADO PESSOAL <br />
          <br />
          <strong>Não fornecimento de Dados Pessoais</strong> <br />
          Você não é obrigado a compartilhar os Dados Pessoais que solicitamos,
          no entanto, se você optar por não os compartilhar, em alguns casos,
          não poderemos fornecer a você acesso completo à Loja, alguns recursos
          especializados ou ser capaz de prestar a assistência necessária ou,
          ainda, viabilizar a entrega do produto ou prestar o serviço contratado
          por você. <br />
          <br />
          ...
          viabilizar a entrega do produto/prestação do serviço por nós. <br />
          No contato a Loja, nós podemos coletar: <br />
          Dados de contato. Nome, sobrenome, número de telefone, cidade, Estado
          e endereço de e-mail; e <br />
          Informações que você envia. Informações que você envia via formulário
          (dúvidas, reclamações, sugestões, críticas, elogios etc.). <br />
          ...
          quando os deduzimos do que sabemos sobre você); <br />
          Dados de navegação na Loja. Informações sobre suas visitas e
          atividades na Loja, incluindo o conteúdo (e quaisquer anúncios) com os
          ...
          Coleta Automática de Dados no item 7 abaixo; <br />
          ...
          desses dados com a tecnologia disponível; e <br />
          Outras informações que podemos coletar. Outras informações que não
          ...
          cookies, pixel tags e outras tecnologias. <br />
          Nós não coletamos Dados Pessoais Sensíveis. <br />
          <br />
          <strong>Compartilhamento de Dados Pessoais com terceiros</strong>{" "}
          <br />
          Nós poderemos compartilhar seus Dados Pessoais: <br />
          ...
          digital e personalizada) e serviços de TI, por exemplo; <br />
          ...
          <br />
          <strong>Transferências internacionais de Dados</strong> <br />
          ...
          esta Política de Privacidade. <br />
          <br />
          <strong>Forma de coleta automática de Dados Pessoais</strong> <br />
          Quando você visita a Loja, ela pode armazenar ou recuperar informações
          em seu navegador, seja na forma de cookies e de outras tecnologias
          semelhantes. Essas informações podem ser sobre você, suas preferências
          ou seu dispositivo e são usadas principalmente para que a Loja
          funcione como você espera. As informações geralmente não o identificam
          ...
          de serviços terceirizados podemos coletar seus Dados Pessoais de
          diversas formas, incluindo, entre outros: <br />
          ...
          assegurar que a Loja funcione adequadamente. <br />
          Uso de cookies: Os cookies permitem a coleta de informações tais como
          o tipo de navegador, o tempo dispendido na Loja, as páginas visitadas,
          as preferências de idioma, e outros dados de tráfego anônimos. Nós e
          nossos prestadores de serviços podemos utilizar essas informações
          para, dentre outros, personalizar sua experiência ao utilizar a Loja,
          assim como para direcionar publicidade para você, de acordo com os
          seus interesses. Também coletamos informações estatísticas sobre o uso
          da Loja para aprimoramento contínuo do nosso design e funcionalidade.{" "}
          <br />
          Caso não deseje que suas informações sejam coletadas por meio de
          cookies, você pode configurar os cookies no menu &quot;opções&quot; ou
          &quot;preferências&quot; do seu browser. Nos links abaixo você encontra mais
          detalhes sobre como ajustar as preferências de cookies dos navegadores
          de internet mais populares: <br />
          Google Chrome <br />
          Mozilla Firefox <br />
          Safari <br />
          ...
          Microsoft Edge <br />
          Opera <br />
          Caso deseje saber um pouco mais sobre os cookies de publicidade e
          remarketing, que servem para direcionarmos publicidade em função dos
          interesses de cada usuário e do número de visitas que realizou em
          nosso site e suas buscas na internet, acesse: <br />
          Facebook <br />
          Google <br />
          Bing <br />
          ...
          dados estatísticos sobre o uso da Loja e taxas de resposta. Em caso de
          ter ativa a personalização de anúncios em ferramentas como Facebook,
          Google ou Bing, a informação pode ser usada para mostrar anúncios em
          seus serviços.  <br />
          No caso de você não desejar ser rastreado pode pedir para cada um dos
          serviços: <br />
          Facebook <br />
          Google <br />
          Bing <br />
          ...
          relatórios sobre os anúncios da Loja em toda a internet. Para isso,
          essas empresas utilizam cookies, pixel tags e outras tecnologias para
          coletar informações sobre a sua utilização, ou sobre a utilização de
          outros usuários, da nossa Loja e de site de terceiros. Nós não somos
          responsáveis por pixel tags, cookies e outras tecnologias similares
          utilizadas por terceiros. Você pode configurar suas preferências no
          menu do seu browser. Esteja ciente de que se você mudar de computador
          ou navegador, ou usar vários computadores ou navegadores, você
          precisará repetir este processo para cada computador e cada navegador.{""}
          <br />
          <br />
          ...
          conta de cumprimento de obrigações legais. <br />
          <br />
          <strong>Segurança dos Dados Pessoais</strong> <br />
          ...
          qualquer um desses sites, lembramos que cada sites possui as suas
          ...
          quaisquer Dados Pessoais para esses sites. <br />
          ...
          aplicativos, relacionadas a jogos, dispositivos ou serviços oferecidos
          por terceiros na Loja. <br />
          <br />
          ...
          refletir as mudanças nas práticas de informações. Publicaremos um
          aviso proeminente em nossa Loja para notificá-lo de quaisquer
          alterações significativas à nossa Política de Privacidade e
          indicaremos no topo desta página a data em que foi atualizada pela
          última vez. <br />
          <br />
          <strong>Fale Conosco</strong> <br />
          Se você tiver alguma dúvida sobre esta Política de Privacidade, entre
          em contato conosco pelo e-mail: contato.jorri@gmail.com <br />
          <br />
