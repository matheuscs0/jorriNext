...
// Defina tipos para as propriedades e para o estado
type Product = {
  id: number;
  name: string;
  price: number;
  ...
  return (
    <Link href="/">
      {products.map((product) => (
        <div className="flex flex-col w-[308px] h-[410px] bg-zinc-100 justify-around items-center p-5 rounded-2xl shadow-md cursor-pointer" key={product.id}>
